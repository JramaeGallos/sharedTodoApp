/*
* TodoListProvider
| Provider file for todo collection
*/
...
class TodoListProvider with ChangeNotifier {
  ...
  void editTodo(String title, String description, Timestamp deadline, String lastEdit) async {
    String message =
        await firebaseService.editTodo(_selectedTodo!.id, title, description, deadline, lastEdit);
    print(message);
    notifyListeners();
  }
