/*
* FirebaseTodoAPI()
| Connects to the firebase for todo collection
*/
...
class FirebaseTodoAPI {
  ...
  Future<String> editTodo(String? id, String title, String description, Timestamp deadline, String lastEdit) async {
    try {
      print("New String: $title");
      await db.collection("todos").doc(id).update({"title": title, "description": description, "deadline":deadline, "lastEdit":lastEdit});
